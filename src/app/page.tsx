  ...
  return (
    <div className="flex flex-col animate-in fade-in duration-500">
        ...
        <div className="container mx-auto px-4 text-center md:px-6">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="text-lg font-light text-muted-foreground">
              ...
              <ul className="mt-4 block w-full max-w-md mx-auto list-disc list-inside text-left space-y-2">
      ...
      <section className="w-full pb-24 pt-8">
        <div className="container mx-auto px-4 text-center md:px-6">
          <div className="rounded-lg border border-primary/10 bg-white/50 p-6 md:p-12 lg:p-16">
            <Button
              asChild
              size="lg"
              className="h-auto whitespace-normal bg-accent px-6 py-4 text-base font-medium text-accent-foreground shadow-md transition-all hover:-translate-y-0.5 hover:bg-accent/90 hover:shadow-lg md:px-16 md:text-lg"
            >
              <Link href="/booking">Book Your First Session - Free</Link>
            </Button>
            <div className="mt-6 text-center text-muted-foreground md:mt-8">
